...
(custom-set-faces
   '(default ((t (:background "#24292E" :foreground "green"))))  ; 全局背景00FF00
   '(hl-line ((t (:background "#2F3336"))))                        ; 高亮当前行
   '(region ((t (:background "green4" :foreground "#FFFFFF"))))    ; 选中区域
   '(linum ((t (:background "#24292E" :foreground "#586E75"))))    ; 行数栏
