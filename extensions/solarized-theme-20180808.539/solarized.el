...
;;;;; basic faces
     ...
     '(tabbar-selected ((t (:inherit tabbar-default :background "#073642" :foreground "#B3B3B3" :overline "gray70" :box (:line-width 1 :color "#073642")))))
     '(tabbar-unselected ((t (:inherit tabbar-default :background "#002B36" :foreground "#969696" :box (:line-width 1 :color "#002B36")))))
